                  ...
                  <tbody className="divide-y divide-slate-50">
                    {segment.wordBreakdown.map((item, idx) => (
                      <tr key={idx} className="hover:bg-indigo-50/40 transition-colors">
                        <td className="px-3 py-3.5 font-bold text-slate-900">{item.targetWord}</td>
                        <td className="px-3 py-3.5 text-slate-700 font-medium">{item.sourceEquivalent}</td>
                        <td className="px-3 py-3.5 text-slate-500 italic leading-snug">{item.context}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
